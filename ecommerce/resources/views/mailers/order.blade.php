													...
													<tr>
														<td valign="top" class="bodyContent">
															<div mc:edit="std_content00">
																<h1 class="h1">Recibo de tu pago en VIVET</h1>
															
																<strong>¡Hola! {{$order->email}}</strong> 
																Estos son los datos de tu compra realizada con nosotros.
															</div>
														</td>
													</tr>
													<tr>
														<td valign="top" style="padding-top:0; padding-bottom:0;">
														  <table border="0" cellpadding="10" cellspacing="0" width="100%" class="templateDataTable">
															  ...
															  @endforeach
																<tr>
																	<td valign="top" class="dataTableContent" mc:edit="data_table_content00">Total</td>
																	<td valign="top" class="dataTableContent" mc:edit="data_table_content00">{{$order->total}}</td>
																</tr>
														  </table>
														</td>
													</tr>
													...
													<tr>
														<td valign="top">
															<div mc:edit="std_footer">
																<em>Copyright &copy; 2017  VIVET, All rights reserved.</em>
																<br />
